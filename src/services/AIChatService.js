        ...
        messages: [
          {
            role: "system",
            content:
              "당신은 응급상황 대처 전문가입니다. 밤길 안전, 응급상황 대처, 범죄 예방 등에 대한 실용적이고 구체적인 상식을 제공해주세요. 제목과 내용을 JSON 형식으로 반환해주세요.",
          },
          {
            role: "user",
            content:
              '응급상황에서 도움이 되는 실용적인 상식 하나를 알려주세요. 제목과 내용을 포함해서 {"title": "제목", "content": "내용"} 형식으로 주세요. 내용은 2-3문장으로 간결하게 작성해주세요.',
          },
        ],
        max_tokens: 300,
        temperature: 0.8,
